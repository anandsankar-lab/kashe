...
24. Dark mode device verification — Session 17
25. react-native-reanimated — restore in Session 17 (native build only)
26. Settings route wiring from AppHeader overflow — Session 16
27. FIRE planner screen — V2
28. AUDIT_STORE key missing from STORAGE_KEYS enum — Session 16
29. Price chart mock data — Session 13 wiring
30. V1 → V2 data migration strategy — pre-V2 planning
31. PARTNER profile type — V2 (requires Supabase couple sync)
32. holdingsContextBuilder wiring to UserFinancialProfile — Session 13 (W-09)
33. insightTriggers wiring to UserFinancialProfile — Session 13 (W-10)
...
35. Portfolio pending queue UX: holdings in pendingCategorizationQueue
    need resolution UI in Sources screen (Session 15).
...
37. GDPR data export flow — "Download my data" — Session 16
38. Clearbit enrichment disclosure in privacy policy — before beta
39. Merchant enrichment opt-in UI in Settings — Session 16
